...
let walletExtensionAddress: string | null =
  '0xFf0dE1ECEb20C2Bb5eb6A0F75D6F10365692B379';
...
function createBrowserExtensionProvider(): ethers.providers.JsonRpcProvider | null {
  try {
